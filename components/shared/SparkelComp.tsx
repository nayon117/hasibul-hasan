  ...
  return (
    <div className="flex  w-full flex-col items-center justify-center overflow-hidden rounded-md bg-black">
      ...
      <div className="relative h-40 w-[40rem]">
        {/* Gradients */}
        <div className="absolute inset-x-20 top-0 h-[2px] w-3/4 bg-gradient-to-r from-transparent via-purple-400 to-transparent blur-sm" />
        <div className="absolute inset-x-20 top-0 h-px w-3/4 bg-gradient-to-r from-transparent via-purple-400 to-transparent" />
